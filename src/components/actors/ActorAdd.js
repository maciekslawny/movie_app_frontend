...
export default class ActorAdd extends Component {
  constructor() {
    super();
    this.state = {
      name: "",
  ...
  handleSubmit = (event) => {
    ...
    axios
      .post(`/api/movies/actors/`, JSON.stringify(this.state), {
        headers: {
          ...
          <div className="col-lg-12 mb-4">
            ...
            <div className="card shadow mb-4">
              <div className="card-header py-3">
                <h6 className="m-0 font-weight-bold text-primary">Add Actor</h6>
              </div>
              <div className="m-3">
